...
| [gerrit-httpd-most-users](resources/default/scripts/httpd/gerrit-httpd-most-users.lnav)         | Report of most active http users                          | start-time: only after time specified (format: 'YYYY-MM-DD HH:MM:SS') | no                           | -       | tbd             |
|                                                                                                 |                                                           | end-time: only before time specified (format: 'YYYY-MM-DD HH:MM:SS')  | yes, if start-time specified | -       | tbd             |
